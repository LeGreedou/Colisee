...
Fonctionne avec un bot Discord pour gérer la création des évènements.

Utilise l'API Riot League of Legends pour obtenir toutes les données liées au comptes des joueurs et au parties.
